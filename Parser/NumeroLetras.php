        ...
        for ($xz = 0; $xz < 3; $xz++) {
                        ...
                        case 1: // checa las centenas
                            if (substr($xaux, 0, 3) < 100) { // si el grupo de tres dígitos es menor a una centena ( < 99) no hace nada y pasa a revisar las decenas
                                ...
                                if (TRUE === array_key_exists($key, $xarray)) {  // busco si la centena es número redondo (100, 200, 300, 400, etc..)
                                    $xseek = $xarray[$key];
                                    $xsub = static::subfijo($xaux); // devuelve el subfijo correspondiente (Millón, Millones, Mil o nada)
            ...
            if (trim($xaux) != "") {
                switch ($xz)
                {
                    ...
                    case 2:
                        if ($xcifra < 1) {
                            $xcadena = "CERO PESOS CON $xdecimales/100 M.N";
                        }
                        if ($xcifra >= 1 && $xcifra < 2) {
                            $xcadena = "UN PESO CON $xdecimales/100 M.N ";
                        }
                        if ($xcifra >= 2) {
                            $xcadena .= " PESOS CON $xdecimales/100 M.N "; //
                        }
                        break;
                } // endswitch ($xz)
            } // ENDIF (trim($xaux) != "")
